(module system racket/base
	...
	(define channels (list
		...
		(cons 12 'chat-channel/firend)
		(cons 14 'chat-channel/party-room)
		(cons 15 'chat-channel/party-member)
		(cons 16 'chat-channel/party-leader)
		(cons 17 'chat-channel/hero-voice)
		(cons 18 'chat-channel/critical-announce)
		(cons 19 'chat-channel/screen-announce)
		(cons 20 'chat-channel/battlefield)
		(cons 21 'chat-channel/mpcc-room)
		(cons 22 'chat-channel/npc-all)
		(cons 23 'chat-channel/npc-shout)
	))
)